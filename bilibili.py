...
if __name__ == '__main__':
    ...
    # except:
    out_file = openpyxl.load_workbook("bilibili_bangumi_3.xlsx")
    ...
    try:
        for i in range(sheet_id, min(sheet_id + 100000, 400000)):
            next_sheet_id = i
            # time.sleep(0.25)
            print(i, end="        ")
            title = get_title(i)
            if title == "412":
                ...
                out_file.save("bilibili_bangumi_3.xlsx")
                title = get_title(i)
